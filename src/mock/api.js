        ...
        data: {
            staff: {
                ...
                vote_start_timestamp:
                    LAST_YEAR + DATETIME_ISO_STRING.substring(4), // this time last year
                vote_end_timestamp:
                    NEXT_YEAR + DATETIME_ISO_STRING.substring(4), // this time next year
            },
        },
    })
...
export { makeMockRegback, makeMockPrinter }
